This sample application is designed to work with TIDv4 and API Cloud V2. This will not be very useful to developers outside of Trimble until the external API marketplace becomes available in 2023.
